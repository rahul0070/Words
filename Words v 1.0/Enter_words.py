...
s = Style()
s.configure('My.TFrame', background='LightCyan2', height=30, width=100)
...
bt=Button(fr)
fr.pack(expand=YES)
l1=Label(fr, text="Enter word", style='My.Label').grid(row=1,column=1)
l2=Label(fr, text="Enter meaning", style='My.Label').grid(row=2,column=1)
e1=Entry(fr)
e2=Entry(fr)
